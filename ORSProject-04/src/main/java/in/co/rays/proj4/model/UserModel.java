...
public class UserModel {
	...
	public long add(UserBean bean) throws ApplicationException, DuplicateRecordException, SQLException {
		Connection conn = null;
		...
		try {
			...
			e.printStackTrace();
			conn.rollback();
			throw new ApplicationException("exception : add roll back exception" + e.getMessage());
		} finally {
			JDBCDataSource.closeConnection(conn);
		}
		return pk;
	...
	public UserBean authenticate(String login, String password) throws ApplicationException{
		...
		try {
			...
			e.printStackTrace();
			throw new ApplicationException("Exception : Exception in get user");
		} finally {
			JDBCDataSource.closeConnection(conn);
		}
		return bean;
